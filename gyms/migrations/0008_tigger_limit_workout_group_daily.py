...
class Migration(migrations.Migration):
    sql = """
        ...
        BEGIN
            ...
            EXECUTE format('SELECT COUNT(*) FROM %s WHERE for_date = ''%s'' and owned_by_class = ''%s'' and owner_id = %s::varchar',TG_ARGV[1], NEW.for_date::date, NEW.owned_by_class, NEW.owner_id)
            INTO row_count;
