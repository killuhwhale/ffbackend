...
class JWTMiddleware:
    ...
    def __call__(self, request):
        ...
        if request.path in ['/hooks/revenuecat/', '/hooks/webhook/', '/hooks/create_checkout/', '/hooks/customer_portal/', '/hooks/session_status/', '/login/', '/register/', '/token/', '/token/refresh/', '/users/', '/user/send_reset_code/', '/user/reset_password/', '/emailvalidation/confirm_email/', '/emailvalidation/send_confirmation_email']:
