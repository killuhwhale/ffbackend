...
class JWTMiddleware:
    ...
    def __call__(self, request):
        ...
        if request.path in ['/login/', '/register/', '/token/', '/token/refresh/', '/users/', '/user/send_reset_code/', '/emailvalidation/confirm_email/', '/emailvalidation/send_confirmation_email']:
